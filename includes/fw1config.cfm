...
*/
	...
	variables.framework.package = 'murawiki';
	variables.framework.packageVersion = '0.1';
	...
	variables.framework.diComponent = variables.framework.package & '.fw1.framework.ioc';
